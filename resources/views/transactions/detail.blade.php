<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            transactions &raquo; {{ $item->food->name }} by {{ $item->user->name }}
        </h2>
    </x-slot>
                    ...
                    <div class="w-full md:w-5/6 px-4 mb-4 md:mb-0">
                        ...
                        <div class="flex flex-wrap mb-3">
                            ...
                            <div class="w-2/6">
                                ...
                                <div class="text-xl font-bold">{{ number_format($item->user->email) }}</div>
                            </div>
                            <div class="w-1/6">
                                <div class="text-sm">City</div>
                                <div class="text-xl font-bold">{{ number_format($item->user->city) }}</div>
                            </div>
                        </div>
                        <div class="flex flex-wrap mb-3">
                            <div class="w-2/6">
                        ...
                        <div class="flex flex-wrap mb-3">
                            ...
                            <div class="w-1/6">
                                ...
                                <a href="{{ route('transactions.changeStatus', ['id' => $item->id, 'status' => 'ON_DELIVERY']) }}"
                                    ...
                                    font-bold px-2 rounded block text-center w-full mb-1">
                                    On Delivery
                                </a>
